...
const ProductDetailSidebar = () => {
  return (
    <div className="product-det-sidebar_wrapp">
      <div className="product-det-sidebar_section">
        <div className="product-det-sidebar_close-btn">
          <Button type="button" color="transparent" icon={<XIcon />} />
        </div>
        <div className="product-det-sidebar_heading-wrapp">
        ...
        <form className="product-det-sidebar_purchase-form">
          <div className="mb-4">
      ...
      <div className="product-det-sidebar_section w-full">
